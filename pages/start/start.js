...
Page({
  ...
  send: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=%E5%8C%97%E4%BA%AC&output=json&ak=oud0cTVVwaVcHONxFLcBQehbrZEX5N7c', //百度天气API
      header: {
  ...
  */
  ...
  onLoad: function (options) {
    let List = getApp().globalData.warning.datapoints;
    this.setData({
      list: List,
    })
  },
